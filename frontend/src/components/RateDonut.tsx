...
export default function RateDonut({ summary, dark }: Props) {
  const data = [
    { name: 'Pass (≥95%)',   value: summary.pass_count, color: '#16a34a' },
    { name: 'Warn (80–95%)', value: summary.warn_count, color: '#d97706' },
    { name: 'Fail (<80%)',   value: summary.fail_count, color: '#dc2626' },
  ]

  const rateColor =
    summary.overall_rate >= 95 ? '#16a34a' :
    summary.overall_rate >= 80 ? '#d97706' : '#dc2626'
